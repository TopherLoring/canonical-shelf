...
function v4Unit(l){const old=Number(l.unit)||0;
 ...
 if(old===3)return 5;if(old===4){if(has(l,/torah|law|sinai|neighbor responsibility|holiness/))return 7;return 6}
 ...
 if(old===6)return 12;if(old===7){if(has(l,/hear the prophets in their own setting|prophetic overview/))return 13;if(has(l,/justice|amos|micah|jeremiah|exilic hope/))return 10;return 13}
 if(old===8)return 14;if(old===9)return 15;if(old===10){if(has(l,/acts|early church|early christian|pentecost|communal discernment|jerusalem council/))return 16;if(has(l,/james|favoritism|general epistle|general letter/))return 18;if(has(l,/paul|letter|body|belong/))return 17;return 16}
 if(old===11)return 19;if(old===12)return 20;if(old===13)return 21;if(old===14)return 22;if(old===15)return 23;if(old===16){if(has(l,/theme|argument|comparison/))return 24;return 25}return 1}
cat.units=units;
