const RELEASE='v7-experience-parity-2026-09-20-a';
const SHELL=`cs-${RELEASE}-shell`,DATA=`cs-${RELEASE}-data`;
const ESSENTIAL=['/','/index.html','/tokens.css','/styles.css','/learning.css','/bible.css','/utility-panels.css','/experience.css','/course-experience.css','/bootstrap.js','/theme.js','/orientation.js','/study-controls.js','/feedback.js','/personal-study.js','/app.js','/experience.js','/progress-experience.js','/course-experience.js','/account-ui.js','/db.js','/sync.js','/generated/account.js','/learning.js','/bible.js','/library-data.js','/library-books-ot.js','/library-books-nt.js','/theologian.js','/manifest.webmanifest','/icon.svg','/data/theology-policy.json'];
