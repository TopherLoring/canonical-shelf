const RELEASE='v6-2026-09-16-c';
const SHELL=`cs-${RELEASE}-shell`,DATA=`cs-${RELEASE}-data`;
const ESSENTIAL=['/','/index.html','/styles.css','/learning.css','/bible.css','/bootstrap.js','/app.js','/db.js','/learning.js','/bible.js','/manifest.webmanifest','/data/theology-policy.json'];
