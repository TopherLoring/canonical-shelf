...
export function lesson({id,unitId,title,reading,ref,objective,body,simple,vocab={},deeper='',drawers=[],visual=null,challenges=[],reflect='',model='',sources=[],extraReadings=[]}){
  ...
  return {id,unitId,title,reading,ref,objective,body,simple,vocab,deeper,drawers,visual,challenges,reflect,model,sources,extraReadings,newCurriculum:true};
}
