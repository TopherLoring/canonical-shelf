...
export const evidence=(title,prompt,items,answer,why,hint='Choose only claims warranted by the evidence presented.')=>({kind:'evidence',title,prompt,items,answer,why,hint});
